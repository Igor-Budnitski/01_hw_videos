...
videosRouter
    ...
    .delete('/videos/all-data', (req: Request, res: Response) => {
        db.videos = [];
    ...
    .post('', (req: Request<{}, {}, VideoInputDto>, res: Response) => {
            ...
            if (errors.length > 0) {
                res.status(HttpStatus.BadRequest).send(createErrorMessages([{field: 'Body check', message: 'Incorrect data passed.'}]));
            }
